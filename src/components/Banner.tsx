...
export default function Banner() {
    ...
    return (
        <div className="flex justify-start px-16 items-start w-screen pb-48 pt-12 bg-fundoBanner bg-center bg-cover bg-no-repeat text-white ">
            <div className="flex flex-col justify-start items-start w-1/2 h-1/2 gap-4 font-semibold">
                <h1 className="text-2xl uppercase border-y-2 p-2 my-[8%] text-darkblue font-extrabold">Retina e Vítreo</h1>
                <p className="text-slate-600 text-lg">Referência no diagnóstico e tratamento das doenças da retina e do vítreo, a Retina e Vítreo Consultoria conta com médicos renomados na área de doenças da retina e vítreo.</p>
