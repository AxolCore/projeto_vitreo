        ...
        <ParallaxProvider>
            <div className="bg-[url('/assets/oculos_desfoque.jpg')] bg-cover bg-fixed bg-center bg-no-repeat w-screen">
                <Parallax className={`flex flex-col w-[40vw] mt-[15vh] ml-[15vw] mobile:w-full mobile:m-auto ${visivel ? "animate-revelar-direita" : "opacity-0"}`} onEnter={() => setVisivel(true)}>
                    ...
                    <div className="flex items-center w-[full] h-[20vh]">
                        <Image className="w-[6vw] h-[6vw] aspect-square rounded-full mr-[2vw]" src={vit} alt="icone1" />
                        <div>
                    ...
                    <div className="flex items-center w-[full] h-[20vh] mt-[10vh]">
                        <Image className="w-[6vw] h-[6vw] aspect-square rounded-full mr-[2vw]"  src={vit} alt="icone1" />
                        <div>
                    ...
                    <div className="flex items-center w-[full] h-[20vh] mt-[10vh] mb-[10vh]">
                        <Image className="w-[6vw] h-[6vw] aspect-square rounded-full mr-[2vw]" src={vit} alt="icone1" />
                        <div>
