...
export default function CardOlhos(){
    ...
    return(
        <div className="flex flex-row mobile:flex-col justify-center w-[70vw] desktop:h-[50vh] mobile:w-screen items-center b-blue-700 mb-8 animate-revelar-esquerda gap-16 my-16">
            <div className="flex group transition-colors duration-200 desktop:h-[50vh] hover:bg-darkblue border-2 border-dashed border-darkblue text-black rounded-xl flex-col gap-2 p-8 items-center justify-center b-green-800 w-[25%] mobile:w-[90vw] ">
            ...
            <div className="flex group transition-colors duration-200 desktop:h-[50vh] hover:bg-darkblue border-2 border-dashed border-darkblue text-black rounded-xl flex-col gap-2 p-2 items-center justify-center b-green-800 w-[25%] mobile:w-[90vw]">
                <Image className="w-36 rounded-full" src={imagemCard} alt="placeholder"/>
