...
export default function CardOlho({titulo, paragrafo}: CardOlhoProps) {
    ...
    return (
        <div className="flex group transition-colors duration-200 aspect-[3/4] hover:bg-darkblue border-2 border-dashed border-darkblue text-black rounded-xl flex-col gap-6 p-4 items-center b-green-800 w-[30%] mobile:w-[90vw] ">
